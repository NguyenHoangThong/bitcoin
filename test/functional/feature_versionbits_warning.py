#!/usr/bin/env python3
# Copyright (c) 2016-2017 The Testcoin Core developers
...
class VersionBitsWarningTest(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because testcoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
