...
void TestGUI()
{
    ...
    QString balanceComparison = TestcoinUnits::formatWithUnit(unit, balance, false, TestcoinUnits::separatorAlways);
    ...
    // Amount input
    TestcoinAmountField* amountInput = receiveCoinsDialog.findChild<TestcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: testcoin:")) != -1);
